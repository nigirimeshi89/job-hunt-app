...
export default function LoginView({ email, setEmail, password, setPassword, loading, onSignIn, onGoogleSignIn }: Props) {
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 p-4 dark:from-slate-900 dark:to-slate-800">
            <div className="bg-white p-8 rounded-xl shadow-xl w-full max-w-sm border border-white/50 dark:bg-slate-800 dark:border-slate-700">
                ...
                <div className="space-y-4">
                    <button onClick={onGoogleSignIn} disabled={loading} className="flex items-center justify-center gap-2 w-full p-3 rounded-lg border border-gray-300 bg-white text-gray-700 font-bold hover:bg-gray-50 transition transform hover:-translate-y-0.5 dark:bg-white dark:text-gray-800">
                        {/* Google Icon SVG */}
